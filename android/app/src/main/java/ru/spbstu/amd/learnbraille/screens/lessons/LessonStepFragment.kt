...
import ru.spbstu.amd.learnbraille.databinding.InnerLessonInfoBinding
...
class LessonStepFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val ls: View = DataBindingUtil.inflate<InnerLessonSymbolBinding>(
            inflater,
...
//            }
        ...
        val li: View = DataBindingUtil.inflate<InnerLessonInfoBinding>(
            inflater,
